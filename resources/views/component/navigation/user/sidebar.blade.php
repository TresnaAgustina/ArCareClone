...
>
  ...
  >
    <!-- Sidebar Menu -->
    <nav
      class="mt-5 px-4 py-4 lg:mt-3 lg:px-6"
      x-data="{selected: $persist('Dashboard'), subpage: $persist('')}"
      x-effect="console.log(selected)"
    >
      <!-- Menu Group -->
      <div>
          ...
          <li>
            ...
            <i class="fa-solid fa-ticket"></i>
              ...
              <svg
                ...
                :class="{ 'rotate-180': (selected === 'Ticket') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              ...
              :class="(selected === 'Ticket') ? 'block' :'hidden'"
              x-effect="console.log(subpage)"
            >
