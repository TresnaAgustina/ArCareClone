        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'Dashboard') || (page === 'ecommerce') }"
            >
              <svg
                class="fill-current"
                width="18"
            ...
            >
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-red-500"
                    href="index.html"
                    :class="page === 'ecommerce' && '!text-primary'"
                    >eCommerce
                  </a>
                </li>
              </ul>
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'Calendar') && (page === 'calendar') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'Profile') && (page === 'profile') }"
              :class="page === 'profile' && 'bg-primary'"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'Forms') || (page === 'formElements' || page === 'formLayout') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'Tables') && (page === 'tables') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'Settings') && (page === 'settings') }"
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'Chart') && (page === 'Chart') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'UiElements') || (page === 'alerts' || page === 'buttons') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-primary text-white dark:bg-meta-4': (selected === 'AuthPages') || (page === 'register' || page === 'login') }"
            >
              <svg
                class="fill-current"
                width="18"
